...
function getSupabase() {
	throw new Error("Supabase is not configured. Copy .env.example to .env and fill in SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY (Supabase → Project Settings → API).");
}
